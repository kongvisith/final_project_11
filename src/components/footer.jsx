...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#0B1120] text-gray-400 py-14 px-6 sm:px-10 lg:px-12 font-sans">
      {}
      <div className="max-w-[1440px] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <div className="flex gap-4 mb-8">
              <a href="#" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-gray-700 transition-all text-gray-400 hover:text-white">
                <FaFacebook size={18} />
              </a>
              <a href="#" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-gray-700 transition-all text-gray-400 hover:text-white">
                <FaTwitter size={18} />
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-white font-bold text-xl tracking-tight">E-Commerce</span>
          </div>
          <p className="text-sm">© {currentYear} P-Service. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
